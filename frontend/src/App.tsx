...
// import PrivateRoute from "@/components/auth/PrivateRoute"; // New path
// import HomeRedirectWrapper from "@/components/common/HomeRedirectWrapper";
...
//             path="/dashboard"
//             element={
//               <PrivateRoute requiresProfileCompletion={true}>
//                 <Dashboard />
//               </PrivateRoute>
//             }
//           />
...
//           />
//           <Route
//             path="/compare-program/:programId"
//             element={
//               <ComparePrograms
//                 isDarkMode={isDarkMode}
//                 onToggleTheme={toggleTheme}
...
// // والد داشبورد (باید داخلش <DashboardLayout> + <Outlet/> داشته باشه)
// import Dashboard from "@/pages/Dashboard";
...
// import PaymentCheckout from "@/pages/Dashboard/Payments/Checkout";
...
// import ProgramsIndex from "@/pages/Dashboard/Programs"; // اگر ساختی
...
//       <AuthProvider>
//         <Routes>
//           {/* خانه: هرجا صلاح می‌دونی بفرست؛ اینجا به داشبورد ریدایرکت شده */}
//           <Route
//             path="/"
//             element={
//               <HomeRedirectWrapper
...
//             }
//           />
//           {/* اگر همچنان /apply-with-us/profile باید به پروفایل برود: */}
//           <Route
//             path="/apply-with-us/profile"
//             element={
//               <PrivateRoute>
...
//             }
//           >
//             {/* پیش‌فرض تب: هر کدام را خواستی بگذار */}
...
//             {/* اگر صفحه‌ی لیست برنامه‌ها داری */}
